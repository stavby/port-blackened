...
export const appUserClassificationActionDtoSchema = z.object({
...
export class AppUserClassificationActionDto extends createZodDto(appUserClassificationActionDtoSchema) {}
